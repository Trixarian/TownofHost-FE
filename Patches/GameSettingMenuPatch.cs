...
public class GameSettingMenuPatch
{
    ...
    private static void SetupAdittionalButtons(GameSettingMenu __instance)
    {
        ...
        SpriteRenderer.sprite = Utils.LoadSprite("TOHFE.Resources.Images.PresetBox.png", 55f);
        ...
        button.FindChild("Normal").FindChild("Background").GetComponent<SpriteRenderer>().sprite = Utils.LoadSprite("TOHFE.Resources.Images.SearchIconActive.png", 100f);
        button.FindChild("Hover").FindChild("Background").GetComponent<SpriteRenderer>().sprite = Utils.LoadSprite("TOHFE.Resources.Images.SearchIconHover.png", 100f);
        button.FindChild("Disabled").FindChild("Background").GetComponent<SpriteRenderer>().sprite = Utils.LoadSprite("TOHFE.Resources.Images.SearchIcon.png", 100f);
